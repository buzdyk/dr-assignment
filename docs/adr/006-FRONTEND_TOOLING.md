...
- **Chart library is a separate decision.** shadcn-vue does not ship charts. Options (Chart.js, ECharts, Recharts-equivalents for Vue) will be picked when [[../todos/active/CHAT_UI]] kicks off.
...
- [[../todos/active/CHAT_UI]] — consumer of this stack; also where the chart-library decision will land.
