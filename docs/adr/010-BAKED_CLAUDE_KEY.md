...
- **The Caddy basic-auth gate ([[../todos/completed/deployment/04-TLS_AND_DNS]]) becomes the key's real perimeter** — anyone past basic auth can burn tokens. Accepted at demo scale; would not survive production.
